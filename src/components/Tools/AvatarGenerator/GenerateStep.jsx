      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
        ...
        {!isGenerating && progress < 100 ? (
          <div className="text-center">
            <div className="bg-light-bg rounded-lg p-8 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-100">
                  <Sparkles className="text-accent mx-auto mb-2" size={24} />
                  <h4 className="font-semibold text-sm text-gray-800">
                    AI-Powered
                  </h4>
                  <p className="text-xs text-gray-600">
            ...
            <button
              ...
              className="px-8 py-4 text-lg rounded-lg font-semibold text-white transition-all duration-300 ease-in-out bg-gradient-to-r from-primary to-accent shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 active:shadow-md"
            >
          ...
          <div className="text-center">
            <div className="mb-8">
              ...
              <p className="text-primary font-medium mb-6">{stage}</p>
        ...
        <div className="flex justify-between mt-8">
          <button
            onClick={onPrevious}
            className="px-6 py-3 rounded-lg font-semibold border-2 border-primary text-primary bg-transparent transition-all duration-300 hover:bg-primary hover:text-white hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
